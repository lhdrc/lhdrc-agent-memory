...
| 项 | 状态 |
|---|---|
| P13.1 BM25 文章级 | **done**（P131-01–04） |
| P13.2 图 10边闭环 | **done**（P132-01–03） |
| P13.3 History 正排 | **done**（P133-01–03） |
| P13.4 Prompt Codex | **done**（P134-01–03） |
| P13.5 真矛盾 | **done**（P135-01–03） |
