...
9. 七期完成后读 [`八期/README.md`](八期/README.md)，按 **P8.1→P8.3**（主线；**P8.4 / P8.5 done**）
...
| [`八期/`](八期/) | **当前主线**：Agent 记忆闭环（挂钩+异步 / 检索分层 / skill 注入）；P8.1 in_progress |
| [`四期/`](四期/) | **补充期**：P4.2 A 已接线；B 迁八期 P8.1；P4.1 MCP/REST 后置 |
