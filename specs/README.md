...
7. 六期完成后读 [`七期/README.md`](七期/README.md)，按 **P7.1→P7.5**（P7.1–P7.2 **done**；P7.3–P7.5 Spec ready）  
8. **补充期**：读 [`四期/README.md`](四期/README.md)，按 **P4.1**（MCP/REST / agent 适配器）——访问面后置  
...
| [`七期/`](七期/) | **当前主线**：P7.1–P7.2 **done**；P7.3–P7.5 Spec ready |
| [`四期/`](四期/) | **补充期**：MCP、REST、agent 适配器（后置） |
