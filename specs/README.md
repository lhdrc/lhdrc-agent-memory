...
5. 三期完成后读 [`五期/README.md`](五期/README.md)，按 **P5.1→P5.5** 主线（已完成），**P5.6** 评测（已完成），**P5.7–P5.8** 增强轨  
6. **补充期**：读 [`四期/README.md`](四期/README.md)，按 **P4.1**（MCP/REST / agent 适配器）——访问面后置，不阻塞架构补齐  
...
| [`五期/`](五期/) | **当前**：架构补齐（P5.1–P5.6 done；P5.7–P5.8 增强轨；不含扩 dream） |
