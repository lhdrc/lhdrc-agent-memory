...
**B 档（每轮 inbox + 门控注入）已迁 [`../八期/P8.1-session-hook-async.md`](../八期/P8.1-session-hook-async.md)**，不再作为四期 DoD。A 档收口（npm publish、P42-13）仍属四期。
...
P4.2 B 档 → [`../八期/`](../八期/)。P4.1 DoD 勾选后，MCP/REST 访问面交付完成。架构侧见 [`../五期/`](../五期/)；会话摄入见 [`../六期/`](../六期/)；LLM 真路径见 [`../七期/`](../七期/)。
